...
export class _Mathfield implements Mathfield, KeyboardDelegateInterface {
  ...
  constructor(
    ...
    markup.push(
      `<span contenteditable=true role=textbox aria-autocomplete=none aria-multiline=false part=keyboard-sink class=ML__keyboard-sink aria-label=math-input autocapitalize=off autocomplete=off autocorrect=off spellcheck=false inputmode=none tabindex=0></span>`
    );
