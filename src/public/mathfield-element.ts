  ...
  /**
    ...
    constructor(options?: Partial<MathfieldOptions>) {
      ...
      if (warnings.length > 0) {
        ...
        if (this.shadowRoot && 'adoptedStyleSheets' in this.shadowRoot) {// @ts-ignore
...
```
  ...
  get expression(): any | null {
    ...
    setValue(value?: string, options?: InsertOptions): void {
        ...
        gDeferredState.set(this, {
            ...
            options: attrOptions,menuItems: undefined,
        });
    }
  ...
  /**
    ...
    if (this._mathfield?.menu?.state !== 'closed') return;if (evt.type === 'pointerdown') this.onPointerDown();
    ...
    this._observer = null;window.queueMicrotask(() =>
        ...
        gDeferredState.set(this, {
            ...
            menuItems: this._mathfield.menu?.menuItems ?? undefined,options,
        });
   ...
   * @category Customization
    ...
    set selection(sel: Selection | Offset) {
        ...
        if (this._mathfield) {
            ...
            requestUpdate(this._mathfield);return;
        }
...
function getOptionsFromAttributes(
    ...
    const result: Partial<MathfieldOptions> = {readOnly: false, disablePhysicalKeyboard: false};
